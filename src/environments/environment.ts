export const environment = {
  production: true,
  commentApi: 'https://script.google.com/macros/s/AKfycbyqWw9wtVL1zpSPeNAEiOlypMt5qvnEzArhtkqdQGneybVYjQZt7dLHidMJ4T3htw7F/exec',
  contactMeForm: 'https://docs.google.com/forms/d/e/1FAIpQLSeBRCEJaE1ryzuUW1B7bTZf8ZUiY_o4kvFJfU94xTzI1kxGQg',
  typeCommissionForm: {
