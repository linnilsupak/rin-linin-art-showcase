    ...
    cups: [
      ...
      wands: [
        ...
        },
        {
          ...
          "description": "ไพ่ 4 คฑา เป็นภาพเด็กผู้หญิงที่นั่งอยู่บนต้นไม้ ตามตัวของเธอมีหยาดเหงื่อราวกับพึ่งปีนต้นไม้สูงนี้ด้วยความอุตส่าหะเสร็จ และตัวเธอกก็กำลังเอนดอกไม้ที่ใหญ่ที่สุดบนต้นเพื่อลิ้มรสน้ำหวานของมัน ซึ่งน้ำหวานนี้ถือเป็นสัญญาณของรางวัลแห่งความอุตส่าหะของเธอ",
          number: 4,
          category: tarotCategory.WANDS,
          upright: {
            ...
            loveMeaning: 'คนที่คุณกำลังจีบอยู่จะเปิดโอกาสให้คุณ หรือคู่ที่คุณครองรักอาจตุกหลุมรักคุณอีกครั้ง',
          ...
          reverse: {
            ...
            financeMeaning: 'การลงทุนที่คุณทำมา อาจไม่ให้ผลตอบแทนเท่าที่ควร อาจถึงเวลาแล้วคุณจะ cut loose แล้วมองหาการลงทุนอื่น',
